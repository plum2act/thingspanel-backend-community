...
CREATE INDEX IF NOT EXISTS idx_tenant_device_time ON device_status_history (tenant_id, device_id, change_time);
...
CREATE TABLE IF NOT EXISTS public.device_topic_mappings (
...
CREATE INDEX IF NOT EXISTS idx_device_topic_mapping_lookup ON public.device_topic_mappings USING btree (device_config_id, direction, enabled, priority);
...
-- ✅2025/11/13 设备列表查询索引
CREATE INDEX IF NOT EXISTS idx_devices_tenant_active_created
